  ...
  ({ classNames: { base, wrapper, ...otherClassNames } = {}, ...props }, ref) => {
    ...
    return (
      <Navbar
        ...
        classNames={{
          base: cn(
            'max-w-xs sm:max-w-md md:max-w-(--breakpoint-sm) mx-auto bg-default-foreground rounded-full pl-4 pr-[18px] md:pr-1.5 py-[5px] top-12 shadow-[0_4px_15px_0_rgba(0,0,0,0.25)]',
            base
          ),
      ...
      >
        <NavbarBrand>
          <Logo className="h-3.5 w-auto text-background" />
        </NavbarBrand>
