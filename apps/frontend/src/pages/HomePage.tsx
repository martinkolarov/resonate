...
import AppScreenshotLight from '@/features/home/components/AppScreenshotLight';
import CenteredNavbar from '@/features/home/components/CenteredNavbar';
import {
  Logo1,
  Logo10,
  Logo2,
  ...
  Logo8,
  Logo9,
} from '@/features/home/components/Logos';
import ScrollingBanner from '@/features/home/components/ScrollingBanner';
...
const logos = [
  ...
  { key: 'logo-6', logo: Logo6 },
  { key: 'logo-7', logo: Logo7 },
  { key: 'logo-8', logo: Logo8 },
...
export function HomePage() {
  return (
    <div className="light relative flex h-screen min-h-dvh w-full flex-col gap-9 overflow-y-auto bg-background p-4 [color-scheme:light] md:gap-12 md:px-10 md:py-[34px]">
      <main className="flex flex-col items-center rounded-2xl bg-hero-section-centered-navbar px-3 md:rounded-3xl md:px-0">
        <section className="my-14 mt-16 flex flex-col items-center justify-center gap-6">
          ...
          <p className="text-center text-base text-default-600 sm:w-[466px] md:text-lg md:leading-6">
            Resonate makes running global teams simple. HR, Payroll, International Employment,
